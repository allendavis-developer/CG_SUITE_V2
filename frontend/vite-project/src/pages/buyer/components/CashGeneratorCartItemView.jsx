...
export default function CashGeneratorCartItemView({ item, savedState, onDeselectCartItem, useVoucherOffers = false }) {
  return (
    <section className="buyer-main-content w-3/5 min-w-0 min-h-0 flex-1 bg-white flex flex-col overflow-y-auto buyer-panel-scroll">
      <div className="flex items-center px-8 bg-gray-50 border-b border-gray-200 sticky top-0 z-40">
        <div className="flex items-center gap-3 py-4">
          ...
          <div>
            <h2 className="text-sm font-bold text-brand-blue">Cash Generator Research Item</h2>
      ...
      <div className="p-8">
        {savedState ? (
          <CashGeneratorResearchForm
            mode="page"
            category={item.categoryObject || { name: 'Cash Generator', path: ['Cash Generator'] }}
            onComplete={() => {}}
