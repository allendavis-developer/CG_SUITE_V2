...
const NotificationToast = ({ id, message, type = 'info', onDismiss }) => {
  ...
  switch (type) {
    case 'success':
      ...
      closeButtonRing = 'focus:ring-green-500/30';
      break;
    case 'error':
      accentBorder = 'border-l-red-500';
      iconColor = 'text-red-600';
      closeButtonRing = 'focus:ring-red-500/30';
      break;
    case 'warning':
      accentBorder = 'border-l-amber-500';
      iconColor = 'text-amber-700';
      closeButtonRing = 'focus:ring-amber-500/30';
      break;
    case 'info':
    default:
      accentBorder = 'border-l-brand-blue';
      iconColor = 'text-brand-blue';
      closeButtonRing = 'focus:ring-brand-blue/40';
      break;
  }
  ...
  return (
    <div
      className={`
        relative flex max-w-full items-start gap-3 rounded-lg border border-slate-200 border-l-4
    ...
    >
      <div className="mt-0.5 flex-shrink-0">
        {type === 'success' && (
          <svg className={`h-5 w-5 ${iconColor}`} fill="currentColor" viewBox="0 0 20 20" aria-hidden>
      ...
      <button
        ...
        className={`flex-shrink-0 rounded p-1 text-slate-600 opacity-70 hover:opacity-100 focus:outline-none focus:ring-2 ${closeButtonRing}`}
      >
