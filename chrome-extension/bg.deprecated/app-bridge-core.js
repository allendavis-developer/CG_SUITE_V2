/**
 * Small shared helpers: pending cleanup, CeX nav scrape, post-login NosPos import tail,
 * and repricing completion ping — used by Web EPOS watch, bridge handlers, and listing flows.
 */
